...
class AppColors {
  ...
  static const Color primarySecondaryBorder = Color(0xFFD6D6D6);
  static const Color primaryBorderHover = Color(0xFF3071C7);
  static const Color primaryHover = Color(0xFF7EAFE0);
  static const Color primaryTextHover = Color(0x80000000);
  static const Color primaryText = Color(0xFF000000);
  static const Color colorTertiaryText = Color(0xFF737373);
