...
func (s *service) CreateAddress(ctx context.Context, customerID uint, req *CreateCustomerAddressRequest) (*CustomerAddress, error) {
	...
	if s.custCheck != nil {
		...
		if !ok { return nil, ErrCustomerMissing }
	}
...
func (s *service) GetAddress(ctx context.Context, id uint) (*CustomerAddress, error) {
	...
	if err != nil { return nil, err }
	if a == nil { return nil, ErrAddressNotFound }
	return a, nil
}
...
func (s *service) UpdateAddress(ctx context.Context, id uint, req *UpdateCustomerAddressRequest) (*CustomerAddress, error) {
	...
	if req.ProvinceID != nil { a.ProvinceID = *req.ProvinceID }
	if req.HouseNumber != nil { a.HouseNumber = req.HouseNumber }
	if req.Village != nil { a.Village = req.Village }
	if req.Moo != nil { a.Moo = req.Moo }
	if req.Soi != nil { a.Soi = req.Soi }
	if req.Road != nil { a.Road = req.Road }
	if req.Subdistrict != nil { a.Subdistrict = req.Subdistrict }
	if req.District != nil { a.District = req.District }
	if req.PostalCode != nil { a.PostalCode = req.PostalCode }
	if req.Country != nil { a.Country = req.Country }
	if req.Latitude != nil { a.Latitude = req.Latitude }
	if req.Longitude != nil { a.Longitude = req.Longitude }

	if err := s.repo.Update(ctx, a); err != nil { return nil, err }
...
func (s *service) DeleteAddress(ctx context.Context, id uint) error {
	...
	if a == nil { return ErrAddressNotFound }
