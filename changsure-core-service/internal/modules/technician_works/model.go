...
type TechnicianWork struct {
	...
	Service  *services.Service     `gorm:"foreignKey:ServiceID;references:ID" json:"service,omitempty"`
	Province *provinces.Province   `gorm:"foreignKey:ProvinceID;references:ID" json:"province,omitempty"`
