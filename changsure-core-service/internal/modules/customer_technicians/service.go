...
type service struct {
	...
	svcRepo  technician_services.Repository
	areaRepo technician_service_areas.Repository
}

func NewService(
	repo Repository,
	tech technicians.Repository,
	svc technician_services.Repository,
	area technician_service_areas.Repository,
) Service {
	return &service{
		repo:     repo,
		techRepo: tech,
